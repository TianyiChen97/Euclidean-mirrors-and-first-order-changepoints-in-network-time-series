9This repository contains code supporting the text "Euclidean mirrors and first-order changepoints in network time series" by Tianyi Chen, Zachary Lubberts, Avanti Athreya, Youngser Park, Carey E. Priebe. 
## Abstract: 
